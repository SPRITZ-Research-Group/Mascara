...
import com.morgoo.droidplugin.$PLUGIN_SERVICE_PROVIDER;
...
public class PluginManager implements ServiceConnection {
    ...
    public void connectToService() {
        if (mPluginManager == null) {
            try {
                Intent intent = new Intent(mHostContext, $PLUGIN_MANAGER_SERVICE.class);
                ...
                args.putString($PLUGIN_SERVICE_PROVIDER.URI_VALUE, "content://" + auth);
                Bundle res = ContentProviderCompat.call(mHostContext, uri,
                        $PLUGIN_SERVICE_PROVIDER.Method_GetManager,
                        null, args);
                if (res != null) {
                    IBinder clientBinder = BundleCompat.getBinder(res, $PLUGIN_SERVICE_PROVIDER.Arg_Binder);
