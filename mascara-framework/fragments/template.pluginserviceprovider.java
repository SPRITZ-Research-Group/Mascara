...
public class $PLUGIN_SERVICE_PROVIDER extends ContentProvider {
    @Override
    ...
    public Bundle call(String method, String arg, Bundle extras) {
        if (Method_GetManager.equals(method)) {
            ...
            BundleCompat.putBinder(bundle, Arg_Binder, $PLUGIN_MANAGER_SERVICE.getPluginPackageManager(getContext()));
            return bundle;
        }
        return null;
    }
