...
//    private static final String ANDROID_OBB = "Android/obb/";
    ...
    public IMountServiceHookHandle(Context context) {
        super(context);
        System.out.println("IMountServiceHookHandle:IMountServiceHookHandle");
    }

    @Override
    protected void init() {
        System.out.println("IMountServiceHookHandle:init");
    ...
    private class mkdirs extends HookedMethodHandler {
        ...
        protected boolean beforeInvoke(Object receiver, Method method, Object[] args) throws Throwable {
            System.out.println("mkdirs:beforeInvoke");
