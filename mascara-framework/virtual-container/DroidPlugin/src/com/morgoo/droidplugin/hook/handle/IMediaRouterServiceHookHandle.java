...
public class IMediaRouterServiceHookHandle extends BaseHookHandle {
    ...
    public IMediaRouterServiceHookHandle(Context hostContext) {
        super(hostContext);
        System.out.println("IMediaRouterServiceHookHandle:IMediaRouterServiceHookHandle");
    }

    @Override
    protected void init() {
        System.out.println("IMediaRouterServiceHookHandle:init");
...
//        public void requestUpdateVolume(IMediaRouterClient client, String routeId, int direction);
    ...
    private class registerClientAsUser extends HookedMethodHandler {
        public registerClientAsUser(Context context) {
            super(context);
            System.out.println("registerClientAsUser:registerClientAsUser");
        }

        @Override
        protected boolean beforeInvoke(Object receiver, Method method, Object[] args) throws Throwable {
            System.out.println("registerClientAsUser:beforeInvoke");
            int index = 1;
