...
public class ServiceManagerCacheBinderHook extends Hook implements InvocationHandler {
    ...
    public ServiceManagerCacheBinderHook(Context hostContext, String servicename) {
        super(hostContext);
        System.out.println("ServiceManagerCacheBinderHook:ServiceManagerCacheBinderHook");
    ...
    protected void onInstall(ClassLoader classLoader) throws Throwable {
        System.out.println("ServiceManagerCacheBinderHook:onInstall");
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        System.out.println("ServiceManagerCacheBinderHook:invoke");
        try {
    ...
    private class ServiceManagerHookHandle extends BaseHookHandle {
        ...
        private ServiceManagerHookHandle(Context context) {
            super(context);
            System.out.println("ServiceManagerHookHandle:ServiceManagerHookHandle");
        }

        @Override
        protected void init() {
            System.out.println("ServiceManagerHookHandle:init");
        ...
        class queryLocalInterface extends HookedMethodHandler {
            public queryLocalInterface(Context context) {
                super(context);
                System.out.println("queryLocalInterface:queryLocalInterface");
            }

            @Override
            protected void afterInvoke(Object receiver, Method method, Object[] args, Object invokeResult) throws Throwable {
                System.out.println("queryLocalInterface:afterInvoke");
    ...
    protected BaseHookHandle createHookHandle() {
        System.out.println("ServiceManagerCacheBinderHook:createHookHandle");
