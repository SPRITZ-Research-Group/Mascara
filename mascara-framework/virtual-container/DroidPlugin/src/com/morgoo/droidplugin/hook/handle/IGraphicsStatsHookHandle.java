...
public class IGraphicsStatsHookHandle extends BaseHookHandle {
    public IGraphicsStatsHookHandle(Context hostContext) {
        super(hostContext);
        System.out.println("IGraphicsStatsHookHandle:IGraphicsStatsHookHandle");
    }

    @Override
    protected void init() {
        System.out.println("IGraphicsStatsHookHandle:init");
    ...
    private class requestBufferForProcess extends HookedMethodHandler {
        public requestBufferForProcess(Context hostContext) {
            super(hostContext);
            System.out.println("requestBufferForProcess:requestBufferForProcess");
        }

        @Override
        protected boolean beforeInvoke(Object receiver, Method method, Object[] args) throws Throwable {
            System.out.println("requestBufferForProcess:beforeInvoke");
            int index = 0;
