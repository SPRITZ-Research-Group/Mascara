...
public class ISearchManagerBinderHook extends BinderHook {
    ...
    public ISearchManagerBinderHook(Context hostContext) {
        super(hostContext);
        System.out.println("ISearchManagerBinderHook:ISearchManagerBinderHook");
    }

    @Override
    Object getOldObj() throws Exception {
        System.out.println("ISearchManagerBinderHook:getOldObj");
    ...
    public String getServiceName() {
        System.out.println("ISearchManagerBinderHook:getServiceName");
        return SEARCH_MANAGER_SERVICE;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("ISearchManagerBinderHook:createHookHandle");
