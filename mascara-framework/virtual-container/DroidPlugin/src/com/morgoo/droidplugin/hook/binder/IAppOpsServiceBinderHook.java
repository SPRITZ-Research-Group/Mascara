...
public class IAppOpsServiceBinderHook extends BinderHook{
    ...
    Object getOldObj() throws Exception {
        System.out.println("IAppOpsServiceBinderHook:getOldObj");
    ...
    public String getServiceName() {
        System.out.println("IAppOpsServiceBinderHook:getServiceName");
        return SERVICE_NAME;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("IAppOpsServiceBinderHook:createHookHandle");
