...
public class IGraphicsStatsBinderHook extends BinderHook {
    ...
    public IGraphicsStatsBinderHook(Context hostContext) {
        super(hostContext);
        System.out.println("IGraphicsStatsBinderHook:IGraphicsStatsBinderHook");
    }

    @Override
    public Object getOldObj() throws Exception{
        System.out.println("IGraphicsStatsBinderHook:getOldObj");
    ...
    public String getServiceName() {
        System.out.println("IGraphicsStatsBinderHook:getServiceName");
        return SERVICE_NAME;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("IGraphicsStatsBinderHook:createHookHandle");
