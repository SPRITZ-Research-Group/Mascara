...
public class IWindowManagerBinderHook extends BinderHook {
    ...
    public IWindowManagerBinderHook(Context hostContext) {
        super(hostContext);
        System.out.println("IWindowManagerBinderHook:IWindowManagerBinderHook");
    }

    @Override
    public Object getOldObj() throws Exception {
        System.out.println("IWindowManagerBinderHook:getOldObj");
    ...
    public String getServiceName() {
        System.out.println("IWindowManagerBinderHook:getServiceName");
        return SERVICE_NAME;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("IWindowManagerBinderHook:createHookHandle");
        return new IWindowManagerHookHandle(mHostContext);
    }

    @Override
    protected void onInstall(ClassLoader classLoader) throws Throwable {
        System.out.println("IWindowManagerBinderHook:onInstall");
    ...
    public static void fixWindowManagerHook(Activity activity) {
        System.out.println("IWindowManagerBinderHook:fixWindowManagerHook");
        try {
