...
public class IMediaRouterServiceBinderHook extends BinderHook {
    ...
    public IMediaRouterServiceBinderHook(Context hostContext) {
        ...
        super(hostContext);
        System.out.println("IMediaRouterServiceBinderHook:ILocationManagerBinderHook");
    }

    @Override
    public Object getOldObj() throws Exception{
        System.out.println("IMediaRouterServiceBinderHook:getOldObj");
    ...
    public String getServiceName() {
        System.out.println("IMediaRouterServiceBinderHook:getServiceName");
        return SERVICE_NAME;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("IMediaRouterServiceBinderHook:createHookHandle");
