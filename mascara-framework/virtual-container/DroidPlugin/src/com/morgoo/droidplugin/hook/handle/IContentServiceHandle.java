...
public class IContentServiceHandle extends BaseHookHandle {
    ...
    public IContentServiceHandle(Context hostContext) {
        super(hostContext);
        System.out.println("IContentServiceHandle:IContentServiceHandle");
    }

    @Override
    protected void init() {
        System.out.println("IContentServiceHandle:init");
    ...
    private static class IContentServiceHookedMethodHandler extends HookedMethodHandler {
        ...
        public IContentServiceHookedMethodHandler(Context hostContext) {
            super(hostContext);
            System.out.println("IContentServiceHookedMethodHandler:IContentServiceHookedMethodHandler");
        }

        @Override
        protected boolean beforeInvoke(Object receiver, Method method, Object[] args) throws Throwable {
            System.out.println("IContentServiceHookedMethodHandler:beforeInvoke");
            if (args != null) {
                final int index = 1;
...
//                        return true;
    ...
    private static class registerContentObserver extends IContentServiceHookedMethodHandler {
        public registerContentObserver(Context hostContext) {
            super(hostContext);
            System.out.println("registerContentObserver:registerContentObserver");
        }
    }
