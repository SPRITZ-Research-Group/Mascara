...
public class IDisplayManagerHookHandle extends BaseHookHandle {
    ...
    public IDisplayManagerHookHandle(Context hostContext) {
        super(hostContext);
        System.out.println("IDisplayManagerHookHandle:IDisplayManagerHookHandle");
    }

    @Override
    protected void init() {
        System.out.println("IDisplayManagerHookHandle:init");
    ...
    private static class createVirtualDisplay extends HookedMethodHandler {
        ...
        public createVirtualDisplay(Context hostContext) {
            super(hostContext);
            System.out.println("createVirtualDisplay:createVirtualDisplay");
        }

        @Override
        protected boolean beforeInvoke(Object receiver, Method method, Object[] args) throws Throwable {
            System.out.println("createVirtualDisplay:beforeInvoke");
