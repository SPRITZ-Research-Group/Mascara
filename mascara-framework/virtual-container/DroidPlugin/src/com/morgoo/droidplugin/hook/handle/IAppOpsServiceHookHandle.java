...
public class IAppOpsServiceHookHandle extends BaseHookHandle {
    ...
    public IAppOpsServiceHookHandle(Context hostContext) {
        super(hostContext);
        System.out.println("IAppOpsServiceHookHandle:IAppOpsServiceHookHandle");
    }

    @Override
    protected void init() {
        System.out.println("IAppOpsServiceHookHandle:init");
...
//        }
    ...
    protected Class<?> getHookedClass() throws ClassNotFoundException {
        System.out.println("IAppOpsServiceHookHandle:getHookedClass");
        return IAppOpsServiceCompat.Class();
    }

    @Override
    protected HookedMethodHandler newBaseHandler() throws ClassNotFoundException {
        System.out.println("IAppOpsServiceHookHandle:newBaseHandler");
