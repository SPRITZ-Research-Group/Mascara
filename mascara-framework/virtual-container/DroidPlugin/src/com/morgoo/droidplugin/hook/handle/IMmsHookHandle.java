...
public class IMmsHookHandle extends BaseHookHandle {
    ...
    public IMmsHookHandle(Context hostContext) {
        super(hostContext);
        System.out.println("IMmsHookHandle:IMmsHookHandle");
    }

    @Override
    protected void init() {
        System.out.println("IMmsHookHandle:init");
