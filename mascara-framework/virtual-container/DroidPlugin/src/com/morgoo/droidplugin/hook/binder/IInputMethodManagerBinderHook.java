...
public class IInputMethodManagerBinderHook extends BinderHook {
    ...
    public IInputMethodManagerBinderHook(Context hostContext) {
        ...
        super(hostContext);
        System.out.println("IInputMethodManagerBinderHook:IInputMethodManagerBinderHook");
    }

    @Override
    public Object getOldObj() throws Exception {
        System.out.println("IInputMethodManagerBinderHook:getOldObj");
    ...
    protected void onInstall(ClassLoader classLoader) throws Throwable {
        System.out.println("IInputMethodManagerBinderHook:onInstall");
    ...
    public String getServiceName() {
        System.out.println("IInputMethodManagerBinderHook:getServiceName");
        return SERVICE_NAME;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("IInputMethodManagerBinderHook:createHookHandle");
