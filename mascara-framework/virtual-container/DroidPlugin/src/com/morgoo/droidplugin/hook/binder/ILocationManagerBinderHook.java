...
public class ILocationManagerBinderHook extends BinderHook {
    ...
    public ILocationManagerBinderHook(Context hostContext) {
        ...
        super(hostContext);
        System.out.println("ILocationManagerBinderHook:ILocationManagerBinderHook");
    }

    @Override
    Object getOldObj() throws Exception {
        System.out.println("ILocationManagerBinderHook:getOldObj");
    ...
    public String getServiceName() {
        System.out.println("ILocationManagerBinderHook:getServiceName");
        return SERVICE_NAME;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("ILocationManagerBinderHook:createHookHandle");
