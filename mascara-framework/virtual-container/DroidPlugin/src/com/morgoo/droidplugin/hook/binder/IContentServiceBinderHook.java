...
public class IContentServiceBinderHook extends BinderHook {
    ...
    public Object getOldObj() throws Exception {
        System.out.println("IContentServiceBinderHook:getOldObj");
    ...
    public String getServiceName() {
        System.out.println("IContentServiceBinderHook:getServiceName");
        return CONTENT_SERVICE_NAME;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("IContentServiceBinderHook:createHookHandle");
