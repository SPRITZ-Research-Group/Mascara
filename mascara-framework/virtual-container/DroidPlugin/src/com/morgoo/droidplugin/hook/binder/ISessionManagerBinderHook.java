...
public class ISessionManagerBinderHook extends BinderHook {
    ...
    public ISessionManagerBinderHook(Context hostContext) {
        super(hostContext);
        System.out.println("ISessionManagerBinderHook:ISessionManagerBinderHook");
    }

    @Override
    public Object getOldObj()  throws Exception{
        System.out.println("ISessionManagerBinderHook:getOldObj");
    ...
    public String getServiceName() {
        System.out.println("ISessionManagerBinderHook:getServiceName");
        return SERVICE_NAME;
    }

    @Override
    protected BaseHookHandle createHookHandle() {
        System.out.println("ISessionManagerBinderHook:createHookHandle");
